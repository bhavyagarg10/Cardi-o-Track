...
//       <div className="w-8 h-8 rounded-full bg-red-500 animate-bounce" />
//       <div className="w-8 h-8 rounded-full bg-red-500 animate-bounce [animation-delay:-.3s]" />
//       <div className="w-8 h-8 rounded-full bg-red-500 animate-bounce [animation-delay:-.5s]" />
//     </div>
//   );
// }
